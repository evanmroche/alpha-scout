...
all_bookmakers = {'FanDuel':'fanduel', 'DraftKings':'draftkings', 'BetMGM':'betmgm', 'Caesars':'williamhill_us',
                  ...
                  'SuperBook':'superbook', 'Bally Bet':'ballybet', 'BetAnySports':'betanysports', 'betPARX':'betparx',
                  'ESPN BET':'espnbet', 'Hard Rock Bet':'hardrockbet', 'Wind Creek (Betfred PA)':'windcreek'}
